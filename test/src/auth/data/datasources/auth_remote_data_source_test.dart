...
void main() {
  ...
  group('signIn', () {
    ...
    test(
      'should throw [ServerException] when user is null after signin in',
      () async {
  ...
  group('updateUser', () {
    ...
    test(
      'should update user profilePic successfuly when no [Exception] is thrown',
      () async {
...
// group('signIn', () {
//     test('should complete successfully whe call to the server is successful',
//         () async {
//       when(
//         () => authClient.signInWithEmailAndPassword(
//           email: any(named: 'email'),
