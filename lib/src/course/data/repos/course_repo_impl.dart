...
/// provides concrete functionality for accessing and manipulating
/// course-related data. It interacts with a remote data source to perform
/// operations such as adding courses and retrieving a list of courses. It uses
/// error handling to manage exceptions and returns results wrapped in `Either`
/// to indicate success or failure in a functional and predictable manner.
class CourseRepoImpl implements CourseRepo {
  ...
  @override
  ResultFuture<void> addCourse(CourseEntity course) async {
    try {
