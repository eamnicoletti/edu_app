...
class CourseModel extends CourseEntity {
  /// Creates a `CourseModel` instance with the provided parameters. This
  /// constructor extends the base `Course` class, inheriting its properties
  /// and behavior.
  const CourseModel({
    required super.id,
  ...
  /// Creates an empty `CourseModel` instance with default values. This
  /// constructor extends the base `Course` class, inheriting its properties
  /// and behavior.
  CourseModel.empty()
      : this(
