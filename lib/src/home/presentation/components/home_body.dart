...
import 'package:edu_app/core/common/widgets/not_found_text.dart';
import 'package:edu_app/core/utils/core_utils.dart';
import 'package:edu_app/src/course/presentation/cubit/course_cubit.dart';
import 'package:edu_app/src/home/presentation/components/home_header.dart';
import 'package:edu_app/src/home/presentation/components/home_subjects.dart';
    ...
    return BlocConsumer<CourseCubit, CourseState>(
      ...
      builder: (context, state) {
        if (state is LoadingCourses) {
          ...
          // Sort the courses based on the updateAt date in descending order
